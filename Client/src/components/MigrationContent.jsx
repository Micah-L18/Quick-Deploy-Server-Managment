...
import { ServerIcon, ChevronRightIcon, AlertIcon, CheckIcon, XIcon } from './Icons';
import styles from './MigrationContent.module.css';
import { io } from 'socket.io-client';

const MigrationContent = ({ deployment, mode = 'copy', isVisible = false }) => {
  ...
  // Reset state when becoming visible or mode changes
  useEffect(() => {
  ...
  }, [isVisible, deployment, isMove, mode]);
          ...
          <div className={styles.actions}>
            {(progress.stage === 'complete' || progress.stage === 'error') && (
              <Button variant="primary" onClick={handleReset}>
                {progress.stage === 'complete' ? 'Done' : 'Try Again'}
              </Button>
            )}
          </div>
        </div>
